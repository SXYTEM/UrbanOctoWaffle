...
client.on("messageCreate", (msg) => {
    ...
    if (DEBUG["CONSOLE"] || DEBUG["FILE"]) {
        ...
        if (DEBUG["FILE"]) log_file(msg, reply_msg);
    }
});
...
function createReply(msg) {
    ...
    var msg_array = msg.content.split(" "); // Array containing all words in "ing"
    ...
    var reply_msg = reply_msg.join(", ");
    var reply_msg = reply_msg[0].toUpperCase() + reply_msg.slice(1) + ".";
    return reply_msg;
}

function log_file(msg, reply_msg, not_sent) {
